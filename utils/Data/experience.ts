export const experiences = [
  {
    ...
    details: [
      "Built NestJS backend APIs with modular architecture for AI-driven calling, booking, and conversation workflows using MongoDB with Mongoose.",
      "Designed optimized MongoDB schemas for conversations, users, appointments and analytics with proper indexing and relationships.",
      "Developed responsive Next.js dashboards using React hooks and modern CSS for managing AI agents and integrations.",
      "Integrated RESTful APIs between Next.js and NestJS with error handling, validation pipes, and middleware.",
      "Created n8n automation workflows for AI agent operations with MongoDB data persistence.",
      "Improved performance through MongoDB query optimization, NestJS caching, and used TypeScript across the stack.",
    ],
  },
  {
    id: 2,
